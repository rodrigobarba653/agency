...
export default function HeroVideo({
  ...
  return (
    ...
    >
      {/* Logo Section - Video on Desktop, SVG on Mobile */}
      <div
        ref={logoContainerRef}
        className="flex items-center justify-center w-full mb-16 -mt-12 md:-mt-24"
      >
        {/* Video Logo - Desktop Only (Viewport Wide) */}
        <div className="hidden md:block w-screen h-full">
          <video
            ref={videoRef}
            src="/videos/logo.mp4"
        ...
        {/* SVG Logo - Mobile Only */}
        <div className="block md:hidden w-full max-w-5xl h-full">
          <div
